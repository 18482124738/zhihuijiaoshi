...
class studentSelf extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <PublicNavBar NavBarTitle={`${state.studentName}同学 — 答题详情`} NavBarLeft={<Icon size="lg" type="left" onClick={() => router.push('/nolayout/teacher/issued/studentTestDetail', { ExamRecordId: state.ExamRecordId })} />} />
        {
            ...
            <div key={v.Id} className={styles.testAllDetailBox}>
              <div className={styles.testAllDetailBoxBody}>
                ...
                <div style={{ display: v.CourseQuestion.Type === 1 || v.CourseQuestion.Type === 2 ? 'block' : 'none' }}>
                  <div className={styles.testAllDetailBBContent}>
                    {
                      v.AnswerItemAnalysis && v.AnswerItemAnalysis.map((s) =>
                ...
                <div className={styles.practiceStuBoxText}>{v.checkShowType}学生答案</div>
